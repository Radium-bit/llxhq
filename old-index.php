...
<body>
    ...
    <main class="main-content mdc-typography mdc-elevation--z8">
        ...
        <h1 class="mdc-typography--headline2">流量消耗器</h1>
		 
        <p class="mdc-typography--body1">多线程消耗流量,web版流量杀手~</p>
          <p class="mdc-typography--body2">Tips: 如手机套餐内定向流量过多，建议直接使用对应流量包的测速节点即可，如头条系流量包，就选字节跳动测速节点，阿里系定向流量包，选阿里测速节点，其他同理 </p>
             <br/>
        <p class="mdc-typography--body2">当前测速源供应商： <a href="aliyun.php">阿里云</a> </p>
     
         <p class="mdc-typography--body2">切换国内其他测速源 :  <a href="jdcloud.php">京东云</a> ，<a href="qcloud.php">腾讯云</a>，<a href="ntes163.php">网易</a>, <a href="baidu.php">百度</a> , 
         <a href="bytedance.php">字节跳动</a></p>
          <p class="mdc-typography--body2">
               <a href="xiaomi.php">小米</a> ，<a href="vivo.php">vivo</a> , <a href="chinamobile10086.php">中国移动商城</a> , <a href="migumusic.php">咪咕音乐(中国移动)</a>
          
          </p>
            <p class="mdc-typography--body2">
              万兆带宽专享：<a href="index.php">拼多多(推荐使用新版测速节点)</a> </a>
          
          </p>
       <!--  <p class="mdc-typography--body1">千兆及以上带宽推荐使用测速源:<a href="baidu.php">百度云</a></p> -->
		  <p class="mdc-typography--body2">海外测速源:<a href="cloudflare.php">cloudflare</a></p>
        <br>
      ...
      <span class="mdc-list-item__primary-text">运行时长</span>
            ...
            <li class="mdc-list-item" data-mdc-auto-init="MDCRipple">
                ...
                <span class="mdc-list-item__text">
      <span class="mdc-list-item__primary-text">IP归属地</span>
                  <span class="mdc-list-item__secondary-text"> <script>ipinfo()</script></span>
                  </span>
            </li>
  ...
  <p class="mdc-typography"> <br/>您的访问信息如下：<br/> <img src="https://ip.vv1234.cn/ipx/" onError="this.src='https://tool.lu/netcard/'"> </p>
   ...
   <!-- <script async src="https://cdn.jsdelivr.net/gh/EvanHahn/HumanizeDuration.js@3.20.0/humanize-duration.min.js" integrity="sha256-/Z/Xzo8lduQxHd+muddFmswME6zBTWH+UGYdNEE0upo=" crossorigin="anonymous"></script>-->
    ...
    <script>
        ...
        var download = function(id) {
            ...
            if (running == true)
                xhr[id] = $.get("https://img.alicdn.com/imgextra/i1/O1CN01xA4P9S1JsW2WEg0e1_!!6000000001084-2-tps-2880-560.png?" + Math.random(), function() {
                    return download(id);
                });
        };
