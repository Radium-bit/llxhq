...
const BASE_CACHE_FILES = [
    'http:///localhost/llxhq/css/dashlite.css',
    'http:///localhost/llxhq/css/style.css',
    'http://localhost/llxhq/fonts/Nioicon.ttf',
    'http://localhost/llxhq/js/common.js',
	'http://localhost/llxhq/js/nioapp.min.js',
	'http://localhost/llxhq/js/script.js',
	'http://localhost/llxhq/js/common.js',
    'http://localhost/js/fuqiang.js',
    'https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js',
    // 'https://cdn.staticfile.net/jquery/3.6.0/jquery.min.js',
    'https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js',
    // 'https://cdn.staticfile.net/bootstrap/4.6.1/js/bootstrap.bundle.min.js',
    'https://cdn.jsdelivr.net/gh/layui/layer@3.5.1/dist/layer.js',
    // 'https://cdn.staticfile.net/layer/3.5.1/layer.js',
    'https://cdn.jsdelivr.net/npm/vue@2.6.14/dist/vue.min.js',
	// 'https://cdn.staticfile.net/vue/2.6.14/vue.min.js',
    'https://cdn.jsdelivr.net/npm/axios@0.26.0/dist/axios.min.js',
	// 'https://cdn.staticfile.net/axios/0.26.0/axios.min.js',
